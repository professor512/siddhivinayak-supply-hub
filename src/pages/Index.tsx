...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative overflow-hidden bg-secondary py-24 md:py-36"
    >
      {/* Background Pattern */}
      ...
      <div className="container relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-secondary-foreground mb-6 animate-fade-in-up">
            Siddhivinayak <span className="text-primary">Enterprises</span>
          </h1>
          ...
          <p className="text-lg md:text-xl text-secondary-foreground/70 mb-10 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            We provide reliable, cost-effective, and customized industrial
            supply solutions to meet diverse customer requirements.
          </p>
...
const AboutSection = () => {
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            {/* Founder Badge */}
           <div className="absolute -bottom-6 left-6 bg-card shadow-lg rounded-2xl px-6 py-4 border">
  ...
  <p className="text-sm text-primary font-semibold mt-1">
    Siddhivinayak Enterprises
            ...
            {/* Decorative element */}
            <div className="absolute -top-6 -right-6 w-28 h-28 bg-primary/10 rounded-2xl -z-10" />
          </div>
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Siddhivinayak Enterprises is a trusted supplier of industrial
              materials, housekeeping products, stationery items, CCTV systems,
              computer accessories, and contract labour services.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              We work round the clock to ensure customer satisfaction through
              quality products, competitive pricing, and timely delivery.
            </p>
  ...
  const features = [
    {
      ...
      description:
        "Tailored industrial solutions designed to meet your specific requirements",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Flexible and hassle-free payment methods for your convenience",
    },
    {
      icon: Award,
      title: "Market-Leading Brands",
      description:
        "Partnerships with top brands like Bosch, 3M, Makita, and more",
    },
    {
      icon: Shield,
...
const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    description:
      "Complete range of protective equipment for health and safety.",
    image: "/covid.jpg",
      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Comprehensive industrial solutions from leading brands.
            Quality products for every requirement.
          </p>
        </div>
...
const ContactSection = () => {
  ...
  const contactInfo = [
    { icon: Globe, label: "Phone ", value: "+91 9970500500" },
    {
      icon: Mail,
      label: "Email",
      value: "siddhivinayakenterprises0104@gmail.com",
    },
    {
      icon: MapPin,
      label: "Location",
